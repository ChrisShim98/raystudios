            ...
            <div className='w-full h-full from-[#000000] bg-gradient-to-r to-[#fff0] z-10'>
              <div className='w-full h-full flex flex-col place-items-center justify-center text-left'>
                <div className='w-full pl-[3vw]'>
                  ...
                  <p className='text-[0.6rem] lg:text-xs pb-4 md:pb-8 pointer-events-none'>We want to convey a sense of mystery, while at the same time being realistic</p>
                  <button className='text-black bg-white hover:bg-[#ffd60a] text-sm px-4 py-2 font-bold'>Our Products</button>
                </div> 
              </div>             
            </div>
            <div className='w-full col-span-10 lg:col-span-6 h-full grid place-items-end'>
