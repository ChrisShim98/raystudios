...
const TermsOfConditions = () => {
  ...
  return (
    <div className="w-full relative z-[4] px-[10vw]">
      <h2 className="text-3xl">
        <strong>Terms of Service</strong>
      </h2>

      <p className="text-lg">Welcome to Ray Studios&#33;</p>

      <p>
        These terms and conditions outline the rules and regulations for the use
        of Ray Studios&#39;s Website, located at raystudios.com.
      </p>

      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use Ray Studios if you do not agree to
      ...
      <p>
        We employ the use of cookies. By accessing Ray Studios, you agreed to
        use cookies in agreement with the Ray Studios&#39;s Privacy Policy.{" "}
      </p>
      ...
      <p>
        Unless otherwise stated, Ray Studios and/or its licensors own the
        intellectual property rights for all material on Ray Studios. All
        intellectual property rights are reserved. You may access this from Ray
        Studios for your own personal use subjected to restrictions set in these
        terms and conditions.
      </p>

      <p>You must not:</p>
      <ul className="list-disc pl-12">
        <li>Republish material from Ray Studios</li>
        <li>Sell, rent or sub-license material from Ray Studios</li>
        <li>Reproduce, duplicate or copy material from Ray Studios</li>
        <li>Redistribute content from Ray Studios</li>
      </ul>
      ...
      <p>
        ...
        exchange opinions and information in certain areas of the website. Ray
        Studios does not filter, edit, publish or review Comments prior to their
        presence on the website. Comments do not reflect the views and opinions
        of Ray Studios,its agents and/or affiliates. Comments reflect the views
        and opinions of the person who post their views and opinions. To the
        extent permitted by applicable laws, Ray Studios shall not be liable for
      ...
      <p>
        Ray Studios reserves the right to monitor all Comments and to remove any
      ...
      <p>
        You hereby grant Ray Studios a non-exclusive license to use, reproduce,
      ...
      <p>
        ...
        the hyperlink compensates the absence of Ray Studios; and &#40;d&#41; the link
      ...
      <p>
        ...
        e-mail to Ray Studios. Please include your name, your organization name,
      ...
      <p>
        No use of Ray Studios&#39;s logo or other artwork will be allowed for
