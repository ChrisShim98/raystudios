...
const Branding = () => {
  return (
    <div className='bg-gray-100 w-screen min-h-[75vh] branding-container text-center pointer-events-none'>
        <div className='w-full min-h-[75vh] flex flex-col lg:flex-row py-20 lg:py-0 place-content-center place-items-center gap-4 lg:gap-6'>
            <div className='w-[75%] lg:w-[25%] flex flex-col place-content-center place-items-center'>
                <div className='border-2 rounded-full border-gray-300 w-20 h-20 flex place-content-center place-items-center'>
